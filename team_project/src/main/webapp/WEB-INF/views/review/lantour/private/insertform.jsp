      ...
      <div class="comment-form-wrap pt-5">
         ...
         <div class="row justify-content-center pb-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
               <!--대분류-->
               <span class="subheading"><a href="${pageContext.request.contextPath }/review/lantour/list.do">LAN TOUR</a></span>
               <!--소분류 영어-->
         ...
         <button class="btn btn" type="button" onClick="location.href='${pageContext.request.contextPath}/review/lantour/list.do'">취소</button>
         <br/>
         <!-- 썸네일 이미지 업로드 폼 -->                              
