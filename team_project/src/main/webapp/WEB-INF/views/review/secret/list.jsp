  	...
  	<div class="container">
		...
		<div class="row justify-content-center pb-5">
			<div class="col-md-12 heading-section text-center ftco-animate">
				...
				<!--소분류 영어-->
				<h2 class="mb-4"><a href="${pageContext.request.contextPath }/review/secret/list.do">Secret</a></h2>
				<!--소분류 한글 -->
				<p id="font_1">숨은여행지</p>
				<!-- 버튼 -->				
				<a id="font_1" href="${pageContext.request.contextPath }/review/secret/private/insertform.do" class="btn btn-primary px-5 py-8 mt-1"> New Post</a>				
			</div>
		</div>	
