         ...
         <h2 id="font_1" class="mb-3" style="text-align: center;">공지</h2>                     
            <div class="about-author d-flex p-6 bg-light">
               ...
               <div style="text-align: center;">
                  <br />
                  <p style="font-weight: bold; color: purple;">동행게시판 작성 양식</p>
                  <p><span style="font-weight: bold; color:black; ">지역,장소 : </span>예) 제주, 제주애월</p>
                  <p><span style="font-weight: bold; color:black; ">일정 : </span>예) 1월8일~1월 10일 (2박 3일)</p>
                  <p><span style="font-weight: bold; color:black; ">성별 : </span>예) 여,남 </p>
