...
import com.team04.spring.review.lantour.dao.LantourDao;
import com.team04.spring.review.lantour.dto.LantourDto;



@Service
public class LantourServiceImpl implements LantourService{
	//의존 객체 DI
	@Autowired
	private LantourDao lantourDao;	
	...
	public void getList(ModelAndView mView, HttpServletRequest request) {
		...
		*/
		...
		//startRowNum 과 endRowNum  을 LantourDto 객체에 담고
		LantourDto dto=new LantourDto();
		...
		//글목록 얻어오기
		list=lantourDao.getlist(dto);
		//글의 갯수
		totalRow=lantourDao.getCount(dto);
	...
	public void getDetail(int num, ModelAndView mView) {
		LantourDto dto=lantourDao.getData(num);
		mView.addObject("dto",dto);
		//조회수
		lantourDao.addViewCount(num);
		
	}
	//글 업데이트
	@Override
	public void updateContent(LantourDto dto) {
		lantourDao.update(dto);
		
	}
	//글 삭제
	@Override
	public void deleteContent(int num) {
		lantourDao.delete(num);
