...
import com.team04.spring.review.food.dao.FoodDao;
...
public class FoodServiceImpl implements FoodService{
	...
	public void getList(ModelAndView mView, HttpServletRequest request) {
		...
		*/
		...
		//startRowNum 과 endRowNum  을 FoodDto 객체에 담고
		...
		//글목록 얻어오기
		list=foodDao.getlist(dto);
		//글의 갯수
		totalRow=foodDao.getCount(dto);
	...
	public void getDetail(int num, ModelAndView mView) {
		FoodDto dto=foodDao.getData(num);
		mView.addObject("dto",dto);
		//조회수
		foodDao.addViewCount(num);
